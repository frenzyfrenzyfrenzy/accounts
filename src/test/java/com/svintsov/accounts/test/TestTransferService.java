...
public class TestTransferService implements TransferService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TestTransferService.class);

    private AccountsRepository accountsRepository;

    public TestTransferService(AccountsRepository accountsRepository) {
    ...
    public void transferMoney(Integer from, Integer to, Integer amount) {
        ...
        throw new RuntimeException("Should rollback on this");
    }
